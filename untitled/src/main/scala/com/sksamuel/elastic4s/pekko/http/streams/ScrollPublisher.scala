...
import com.sksamuel.elastic4s.ElasticApi.{clearScroll, searchScroll}
...
import com.sksamuel.elastic4s.requests.searches.SearchHandlers._
import com.sksamuel.elastic4s.requests.searches.SearchScrollHandlers._
...
class PublishActor(client: ElasticClient, query: SearchRequest, s: Subscriber[_ >: SearchHit], max: Long)(implicit executionContext: ExecutionContext)
    extends Actor
    with Stash {
